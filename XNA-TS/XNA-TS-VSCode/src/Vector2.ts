class Vector2 {
    ...
    public static Transform2(value: Vector2, rotation: Quaternion): Vector2 {
        let num1: number = rotation.X + rotation.X;
        let num2: number = rotation.Y + rotation.Y;
        let num3: number = rotation.Z + rotation.Z;
        let num4: number = rotation.W * num3;
        let num5: number = rotation.X * num1;
        let num6: number = rotation.X * num2;
        let num7: number = rotation.Y * num2;
        let num8: number = rotation.Z * num3;
        let num9: number = (value.X * (1.0 - num7 - num8) + value.Y * (num6 - num4));
        let num10: number = (value.X * (num6 + num4) + value.Y * (1.0 - num5 - num8));
        let vector2: Vector2;
        vector2.X = num9;
        vector2.Y = num10;
        return vector2;
